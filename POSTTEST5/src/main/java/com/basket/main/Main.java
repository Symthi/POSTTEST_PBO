...
import com.basket.model.Person;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("5. Demo Polymorphism (Override & Overload)");
            System.out.println("6. Demo Interface (Kontrak Olahraga)");
    ...
    static void initData() {
        ...
        daftarOfficial.add(new Official("Scott Foster", "Wasit"));
        daftarOfficial.add(new Official("Mike Callahan", "Wasit"));
        daftarOfficial.add(new Official("Marc Davis", "Scorer"));
    }

    static void demoInterface() {
        System.out.println("--- Demo pada Atlet ---");
        if (!daftarAtlet.isEmpty()) {
            Atlet atletDemo = daftarAtlet.get(0);
            System.out.println("Atlet: " + atletDemo.getNama());
            atletDemo.tampilkanKontrak();
            System.out.println();
        }

        System.out.println("--- Demo pada Pelatih ---");
        if (!daftarPelatih.isEmpty()) {
            Pelatih pelatihDemo = daftarPelatih.get(0);
            System.out.println("Pelatih: " + pelatihDemo.getNama());
            pelatihDemo.tampilkanKontrak();
            System.out.println();
        }
    }
    ...
    static void lihatSemuaPerson() {
        ...
        if (daftarAtlet.isEmpty()) {
            System.out.println("  (Belum ada atlet)");
        } else {
        ...
        if (daftarPelatih.isEmpty()) {
            System.out.println("  (Belum ada pelatih)");
        } else {
        ...
        if (daftarOfficial.isEmpty()) {
            System.out.println("  (Belum ada official)");
        } else {
            for (Official o : daftarOfficial) {
    ...
    static void demoPolymorphism() {
        System.out.println("\n=== DEMO POLYMORPHISM ===");
        System.out.println("BIODATA (Override Method)");
        Person[] persons = {
                daftarAtlet.get(0),
                daftarPelatih.get(0),
                daftarOfficial.get(0)
        };
        for (Person p : persons) {
            System.out.println(p.biodata());
        }

        System.out.println("\n--- Jadwal Pertandingan (Overload Method) ---");
        Tim tim1 = daftarTim.get(0);
        tim1.jadwalPertandinganKlub();
        tim1.jadwalPertandinganKlub("14 April 2026");
        tim1.jadwalPertandinganKlub("16 April 2026", "Mavericks");
    }
    ...
    static void menuAtlet() {
        ...
        do {
            ...
            sc.nextLine();
            switch (pilih) {
                case 1: tambahAtlet(); break;
                case 2: lihatAtlet(); break;
                case 3: updateAtlet(); break;
                case 4: hapusAtlet(); break;
                case 5: System.out.println("Kembali ke menu utama."); break;
    ...
    static void menuTim() {
        ...
        do {
            ...
            switch (pilih) {
                ...
                case 2: lihatTim(); break;
                case 3: updateTim(); break;
